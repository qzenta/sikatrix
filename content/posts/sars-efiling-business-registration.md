...
description: "A step-by-step guide to setting up your company on SARS eFiling: registering the responsible representative, activating the correct tax types, and linking your bank account."
...
social:
  ogTitle: "How to Register on SARS eFiling: Step-by-Step | Sikatrix"
  ogDescription: "Set up your company's SARS eFiling profile: responsible representative, tax types, and bank account. Complete step-by-step guide."
...
On the 'Manage Tax Types' screen, select 'Register New' or 'Add Tax Type'. Enter the company's Income Tax reference number and select 'Company Income Tax (CIT)' as the tax type. SARS will send an OTP to the company's registered contact details, so you will need access to that number or email to complete verification. Once confirmed, the company appears under your eFiling portfolio.
...
**Using the wrong representative:** The person registered as the representative must be a director or public officer of the company. Using an employee's personal profile creates complications when staff change.

**Mismatching reference numbers:** Corporate Income Tax, PAYE, and VAT each have separate reference numbers. Entering a VAT number into the CIT field, or vice versa, will fail.

**Not activating all relevant tax types:** It is common for businesses to activate only CIT and then discover they cannot access eFiling for PAYE or VAT when those deadlines arrive.
