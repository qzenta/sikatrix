---
title: "SARS Tax Clearance Certificates: What They Are and How to Get One"
description: "SARS replaced the paper TCC with a digital PIN system. Here's what triggers the requirement, how to apply on eFiling, and what to do when your application is blocked."
...
1. Log in to [SARS eFiling](https://www.sars.gov.za/efilehome/)
2. Click **Tax Status** in the top navigation
3. Select **My Compliance Profile**
4. Review your profile — all line items must show green before a PIN will be issued
5. If compliant, click **Activate My TCS PIN** or **Request TCS PIN**
6. Select the PIN type
7. The PIN generates immediately and appears under **My TCS PIN**
