...
export default function BlogListing({ posts }: BlogListingProps) {
  ...
  return (
    <div>
      ...
      {/* 2-column: Latest + Featured on left, sidebar on right */}
      {(latestPost || featured) && (
        <div className="grid lg:grid-cols-[1fr_280px] gap-8 mb-12">
          {/* Left column */}
          <div className="space-y-6">
            ...
            {latestPost && (
              <div>
                ...
                >
                  <div className="relative sm:w-56 h-44 sm:h-auto flex-shrink-0 bg-brand/10">
      ...
      {rest.length > 0 && (
        <div>
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs font-semibold uppercase tracking-widest text-neutral-400">All Articles</span>
            <div className="h-px flex-1 bg-neutral-200" />
          </div>
