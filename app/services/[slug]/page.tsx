...
const SERVICE_ARTICLE_MAP: Record<string, string[]> = {
  ...
  "bookkeeping":                 ["small-business-bookkeeping-mistakes", "cloud-accounting-vs-desktop", "bookkeeping-vs-accounting-sme-south-africa", "monthly-bookkeeping-checklist-south-african-small-businesses"],
